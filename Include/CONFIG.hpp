...
#define TC_PRECOMPUTE_COUNTS 1 // CCS 22 ORCompact
#define TC_OPT_SWAP_FLAG 1 // CCS 22 ORCompact, what is this?

#define K 16 // HTree branching factor

// static unsigned char *aes_key = (unsigned char *)"012345678901234";
// static unsigned char *hardcoded_iv = (unsigned char *)"01234567890";
...
const float SF = 0.1; // tpc-h scale factor
